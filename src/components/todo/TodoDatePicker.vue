...
.time-row { justify-content:center; gap:7px; margin-top:9px; padding-top:9px; border-top:1px solid rgba(0,0,0,.08); }.time-row input { width:48px; border:1px solid rgba(0,0,0,.15); border-radius:6px; padding:4px; text-align:center; font-size:13px; font-family:inherit; }
