...
<template>
  <div class="date-picker" @click.stop>
    <header class="picker-head">
      ...
      <div class="month-nav">
        <button title="上个月" @click="changeMonth(-1)">‹</button>
        <button title="下个月" @click="changeMonth(1)">›</button>
      </div>
    </header>
...
.month-nav { gap:2px; }.month-nav button { width:24px; height:24px; border:0; border-radius:4px; background:transparent; color:#555; font-size:18px; line-height:1; cursor:pointer; }.month-nav button:hover { background:rgba(79,124,255,.1); color:#4f7cff; }
