...
<template>
  <section class="todo-lower" @click.self="openPicker = null" @scroll="openPicker = null">
    ...
    <div v-if="item" class="fields">
      ...
      <button v-if="!isChild" class="add-child-btn" @click="emit('createChild')"><i class="ri-add-line"></i> 添加子任务</button>
